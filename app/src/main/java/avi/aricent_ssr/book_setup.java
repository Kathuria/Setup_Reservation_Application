...
public class book_setup extends Activity implements OnClickListener{

                Button btn,reset;
                Spinner spn,timespin,typespin,empspin;
                ...
                static final int DATE_PICKER_ID = 1111;
                  ...
                  public void onCreate(Bundle savedInstanceState) {
                   ...
                   setContentView(R.layout.book_setup);
                    
                   fromLabel = (EditText) findViewById(R.id.fromdateA);
                   dateFormatter = new SimpleDateFormat("dd-MM-yyyy", Locale.US);
                     
                    //getting button, spinner, edittext, textview from layout file
                    btn = (Button) findViewById(R.id.booksetupbuttonA);
                    reset = (Button)findViewById(R.id.resetA);
             		spn = (Spinner) findViewById(R.id.BookingSpinnerA);
             		nLabel = (EditText) findViewById(R.id.mNameA);
             		tLabel = (EditText) findViewById(R.id.tNameA);
             		toLabel = (EditText) findViewById(R.id.todateA);
             		otherLabel = (EditText) findViewById(R.id.otherDetailsA);
             		timespin = (Spinner) findViewById(R.id.TimeSlotSpinnerA);
             		typespin = (Spinner) findViewById(R.id.BookingTypeSpinnerA);
             		empspin =  (Spinner) findViewById(R.id.eNameSpinnerA);
             		cdtv = (TextView) findViewById(R.id.cdtvA);
             		textfrom = (TextView) findViewById(R.id.textfromA);
             		textto = (TextView) findViewById(R.id.texttoA);
             		ctstv = (TextView) findViewById(R.id.ctstvA);
             		total = (TextView) findViewById(R.id.totalA);
             		avail = (TextView) findViewById(R.id.availabilityA);
             		//loading data in setup spinner from database
             		loadBookSpinnerData();
             		//loading data in employee spinner from database
             		eNameSpinnerData();
                 ...
                 // employee list spinner on click listener
             		empspin.setOnItemSelectedListener(new OnItemSelectedListener() {
             			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
             				eName=empspin.getSelectedItem().toString();
             			}
                 	...
                 	btn.setOnClickListener(new View.OnClickListener() {
             		    public void onClick(View v) {     		    	
             		    	if(text.equals("Select"))
             		    	{
             		    		...
             		    		else if(eName.equals("No User Exists")){
		             		    		...
		             		    		if(type.equals("According to time")){
		             		    			if(slot=="No Slot Available"){
				             		    		...
				             		    		// calling method to setup booking
				             		    			row = bookSetupAdapter.storeSetup(text,mName,tName,from,to,slot,eName,other);
		             		    			}
		             		    		    }
                ...
                //-----------------------------loading employee spinner data--------------------------//
                  
                     private void eNameSpinnerData() {
                         // database handler

                    	 MainDatabaseHandler db = new MainDatabaseHandler(getApplicationContext());
                  
                         List<String> labels = db.load();  
                         if(labels.isEmpty())
                         {
                         	ArrayList<String> d = new ArrayList<String>();
                         	d.add("No User Exists");
                         ...
                         // attaching data adapter to spinner  
                         empspin.setAdapter(dataAdapter); 
                     	}
                     }
