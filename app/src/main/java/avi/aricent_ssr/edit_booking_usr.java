...
@SuppressLint("SimpleDateFormat") public class edit_booking_usr extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 setContentView(R.layout.edit_booking_usr);
		 ...
		 bookSetupAdapter_usr=new bookSetupAdapter_usr(this);
  		...
  		//getting button, spinner, edittext, textview from layout file
  		 details = (TextView) findViewById(R.id.DetailsEU);
  		 otherLabel = (EditText) findViewById(R.id.otherDetailsEU);
  		 typespin = (Spinner) findViewById(R.id.BookingTypeSpinnerEU);
  		 cdtv = (TextView) findViewById(R.id.cdtvEU);
  		 fromLabel = (EditText) findViewById(R.id.fromdateEU);
 		 toLabel = (EditText) findViewById(R.id.todateEU);
 		 textfrom = (TextView) findViewById(R.id.textfromEU);
 		 textto = (TextView) findViewById(R.id.texttoEU);
 		 ctstv = (TextView) findViewById(R.id.ctstvEU);
 		 total = (TextView) findViewById(R.id.totalEU);
 		 avail = (TextView) findViewById(R.id.availabilityEU);
 		 timespin = (Spinner) findViewById(R.id.TimeSlotSpinnerEU);
		 btn = (Button) findViewById(R.id.editbookbuttonEU);
 		    		...
 		    		if(from==null){
 		    			Toast.makeText(getApplicationContext(), "Choose Date", Toast.LENGTH_LONG).show();
         		    		...
         		    		if(type.equals("According to time")){
         		    			if(slot=="No Slot Available"){
         		    				...
         		    				row=0;
	             		    		    ...
	             		    		    to=null;
	             		    			row = bookSetupAdapter_usr.updateSetup(text,text1,text2,text3,from,to,slot,eName,other);
         		    			}
         		    		 }
         		    		else{
         		    			if(to==null){
         		    		...
         		    		if (row > 0) {
         		    			 ...
         		    			 Toast.makeText(getApplicationContext(), "Booking Update Successfully!!", Toast.LENGTH_LONG).show();
        					      edit_booking_usr.this.finish();
         						} 
         						else {
